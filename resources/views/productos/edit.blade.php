            ...
            <div class="form-container">
                <form method="POST" action="{{ route('productos.update', $producto->id_producto) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="id_producto" id="id_producto" value="{{ $producto->id_producto }}" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" id="nombre" maxlength="50" value="{{ $producto->nombre }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" required>{{ $producto->descripcion }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="cantidad" id="cantidad" min="0" value="{{ $producto->cantidad }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="costo" id="costo" min="0" step="0.01" value="{{ $producto->costo }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="iva" id="iva" min="0" step="0.01" value="{{ $producto->iva }}" required>
                    </div>
