...
{{-- <div class="container">
    ...
    <div class="header">
        <h1><i class="fas fa-motorcycle"></i> Lista de Patinetas</h1>
...
{{-- <main class="main-content"> --}}
    <div class="container" style="max-width: 1200px; margin: 40px auto 0 auto; background: #fff; border-radius: 10px; box-shadow: 0 0 20px rgba(0,0,0,0.1); padding: 30px;">
        <div class="header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px; flex-wrap: wrap; gap: 20px;">
            <h1 style="color: #2c3e50; font-weight: 600; margin: 0; display: flex; align-items: center; gap: 10px;"><i class="fas fa-motorcycle"></i> Listado de Patinetas</h1>
            <a href="{{ route('patinetas.create') }}" class="btn btn-primary">
                <i class="fas fa-plus"></i> Nueva Patineta
            </a>
        </div>
