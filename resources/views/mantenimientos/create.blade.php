...
<head>
    ...
    <title>Dashboard - Crear Mantenimiento</title>
    <!-- Font Awesome -->
    ...
    <style>
        ...
        * {
        ...
        /* Estilos del formulario de Mantenimiento */
        .container {
            max-width: 800px;
            margin: 0 auto;
...
<body>
    ...
    <!-- Main Content con el formulario de Mantenimiento -->
        ...
        <div class="container">
            ...
            <form method="POST" action="{{ route('mantenimientos.store') }}">
                ...
                <div class="form-group">
                    ...
                    <select name="id_orden" id="id_orden" required>
                        ...
                        @foreach ($ordenes as $orden)
                            <option value="{{ $orden->id_orden }}">Orden #{{ $orden->id_orden }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="total" id="total" min="0" step="0.01" required>
                </div>
