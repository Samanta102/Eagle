...
<li class="nav-item dropdown no-arrow">
    ...
    <img class="img-profile rounded-circle" src="{{ Auth::user()->url_imagen_perfil }}" alt="Profile Picture" width="35" height="35">
    </a> --}}
    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in mt-2" aria-labelledby="userDropdown" style="min-width: 220px;">
        {{-- <div class="text-center p-2">
            <p class="text-gray-600 mb-1" title="{{ Auth::user()->email ?? 'correo@ejemplo.com' }}">
                <span>{{ Auth::user()->email ?? 'correo@ejemplo.com' }}</span>
            </p>
            <div class="dropdown-divider"></div>
            <img class="img-profile rounded-circle mb-2" src="{{ Auth::user()->url_imagen_perfil }}" alt="Profile Picture" width="70" height="70">
            <h6 class="text-gray-600 font-weight-bold">
                {{ Auth::user()->nombre_completo ?? 'Usuario de English Link' }}
            </h6>
        </div> --}}
