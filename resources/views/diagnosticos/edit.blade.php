    ...
    <div class="container">
        ...
        <form action="{{ route('diagnosticos.update', $diagnostico->id_diagnostico) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="descripcion" name="descripcion" required>{{ $diagnostico->descripcion }}</textarea>
            </div>

            <div class="form-group currency-input">
                <label for="costo_total">Costo Total:</label>
                <input type="number" step="0.01" id="costo_total" name="costo_total" value="{{ $diagnostico->costo_total }}" required>
            </div>
