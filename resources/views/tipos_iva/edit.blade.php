...
<head>
    ...
    <title>Editar Tipo de IVA - Electric House</title>
    <style>
        :root {
            ...
            <div class="form-container">
                ...
                <form action="{{ route('tipos-iva.update', $tipo->id_iva) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_producto" id="id_producto" required>
                            @foreach ($productos as $p)
                                <option value="{{ $p->id_producto }}" {{ $p->id_producto == $tipo->id_producto ? 'selected' : '' }}>
                                    {{ $p->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre_iva" id="nombre_iva" value="{{ $tipo->nombre_iva }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="porcentaje" id="porcentaje" value="{{ $tipo->porcentaje }}" min="0" step="0.01" required>
                    </div>
